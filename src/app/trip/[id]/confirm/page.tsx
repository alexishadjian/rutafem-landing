...
const ConfirmContent = ({ tripId }: { tripId: string }) => {
    ...
    const handleConfirm = async () => {
        ...
        try {
            ...
            const bothConfirmed =
                updatedBooking.driverConfirmedAt && updatedBooking.passengerConfirmedAt;
    ...
    const handleDispute = async () => {
        ...
        try {
            ...
            const disputerName = isDriver
                ? trip.driver?.firstName
                : user.displayName || 'Utilisatrice';
    ...
    return (
        <div className="p-6">
            <div className="mb-6 text-center">
                <Link
                    href={`/trip/${tripId}`}
                    className="flex items-center gap-2 mb-4 hover:text-[var(--pink)]"
                >
                ...
                <h1 className="text-3xl font-staatliches text-[var(--black)]">
            ...
            {bookingStatus === 'captured' && (
                <div className="bg-green-50 border border-green-200 rounded-xl p-4 mb-6 text-center">
                    ...
                    <p className="text-green-700 text-sm mt-1">
                        Le trajet a été validé par les deux parties.
                    </p>
                </div>
            )}
            ...
            {bookingStatus === 'disputed' && (
                <div className="bg-orange-50 border border-orange-200 rounded-xl p-4 mb-6 text-center">
                    ...
                    <p className="text-orange-700 text-sm mt-1">
                        Notre équipe va examiner la situation.
                    </p>
                </div>
            )}
                    ...
                    {alreadyConfirmed ? (
                        <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 mb-6 text-center">
                            ...
                            <p className="text-blue-700 text-sm mt-1">
                                ...
                                {isDriver ? 'la voyageuse' : 'la conductrice'}.
                            </p>
                        </div>
                    ) : state === 'confirmed' ? (
                        <div className="bg-green-50 border border-green-200 rounded-xl p-4 mb-6 text-center">
                        ...
                        <div className="space-y-4">
                            ...
                            <p className="text-xs text-gray-500 text-center mt-4">
                                Sans action de votre part, le paiement sera automatiquement validé
                                24h après le trajet.
                            </p>
                        </div>
                    )}
