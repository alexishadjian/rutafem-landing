                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className={`time-input w-full px-3 sm:px-4 py-2.5 sm:py-3 border rounded-lg focus:ring-2 focus:ring-[--accent-color] focus:border-transparent text-sm sm:text-base ${errors.time ? 'border-red-500' : 'border-gray-300'
                                        }`}
                                />
                                {errors.time && (
                                    <p className="text-red-500 text-xs sm:text-sm mt-1">
